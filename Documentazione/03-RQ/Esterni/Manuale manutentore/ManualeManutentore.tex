...
\docStatus{Approvato}
\docEditors{Giovanni Damo \\ & Giulia Petenazzi}
\docVerificators{Leonardo Brutesco \\ & Marco Pasqualini}
...
\input{sections/ManManIntroduzione.tex}
\input{sections/ManManTecnologieUtilizzate.tex}
\input{sections/ManManConfigurazioneAmbienteDiLavoro.tex}
\input{sections/ManManArchitetturaDeGeOP.tex}
\input{sections/ManManComponenti.tex}
\input{sections/ManManEstensioneDelleFunzionalita.tex}
\input{sections/ManManEstensioneDelCodice.tex}

\appendix
\input{sections/ManManGlossario.tex}
\end{document}

%ATTENZIONE concentrarsi maggiormente su esempi concreti di manutenzione, assumendo (e richiedendo) che lo sviluppatore conosca già le tecnologie che dovrà utilizzare.

%AAA Manca completamente un Glossario dedicato.
%AAA Qual è l’URL al quale collegarsi per accedere al sistema? 
%AAA Non è descritto il processo di segnalazione di eventuali errori del prodotto. Il documento è completamente privo di immagini che aiutino l’utente a collegare le descrizioni presenti al prodotto vero e proprio.
