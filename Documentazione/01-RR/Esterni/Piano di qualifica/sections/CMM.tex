...
Il \glo{CMM}{CMM} è stato sviluppato dal \glo{SEI}{SEI} e promosso e finanziato dal Dipartimento della Difesa statunitense per valutare la qualità dei processi software delle organizzazioni che collaboravano con esso.
...
\begin{itemize}
\item  \textbf{livelli di maturità:} il \glo{CMM}{CMM} identifica un processo continuo di maturazione a cinque livelli (in cui il maggiore è uno stato ideale dove i processi sono sistematicamente gestiti da una combinazione di ottimizzazione e miglioramento del processo);
