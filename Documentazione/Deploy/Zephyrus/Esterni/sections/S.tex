...
%\gref{Sinon}
%Framework per testare \glo{JavaScript}{JavaScript} che fornisce spie, stub, mock.
...
\begin{enumerate}
	...
	\item software di messaggistica utilizzato dal \glo{Gruppo}{gruppo} \zephyrus{} per comunicare internamente al gruppo e con l'azienda \riskapp.
\end{enumerate}
