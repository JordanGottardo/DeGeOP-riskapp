...
\begin{document}
	...
	\input{sections/TecnologieUtilizzate.tex}
	\input{sections/DescrizioneArchitettura.tex}
	\input{sections/Componenti.tex}
	\input{sections/StimeDiFattibilitaEDiBisognoDiRisorse.tex}
	\input{sections/DiagrammiDiAttivita.tex}
	\input{sections/Tracciamento.tex}
	\appendix
	\input{sections/DescrizioneDesignPattern.tex}
\end{document}