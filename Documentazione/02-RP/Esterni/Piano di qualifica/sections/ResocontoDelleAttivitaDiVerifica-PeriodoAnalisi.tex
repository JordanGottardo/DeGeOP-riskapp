...
\section{Resoconto delle attività di verifica - Periodo Analisi}
	\subsection{Verifica dei processi}
		...
		\subsubsection{Considerazioni finali}
			...
			\label{RRDP}
				Il ritardo riscontrato nel periodo di Analisi è pari a 3 giorni. Dato che il ritardo è all'interno della soglia di accettabilità, il \glo{Gruppo}{team} è ancora in grado di rispettare la scadenza. L'obiettivo è cercare di evitare ritardi nei periodi successive.
			...
			\subsection{Verifica dei prodotti}
				\subsubsection{Verifica dei documenti}
					...
					%TOCHECK	\textit{Analisi dei requisiti v1.0.0}
